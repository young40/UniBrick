...
{
    unsafe class TinaX_Systems_ITimeTicket_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(TinaX.Systems.ITimeTicket);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new TinaX.Systems.ITimeTicket[s]);
        ...
        static StackObject* get_id_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            TinaX.Systems.ITimeTicket instance_of_this_method = (TinaX.Systems.ITimeTicket)typeof(TinaX.Systems.ITimeTicket).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Unregister_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
