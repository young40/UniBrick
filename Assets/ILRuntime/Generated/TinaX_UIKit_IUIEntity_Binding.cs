...
{
    unsafe class TinaX_UIKit_IUIEntity_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(TinaX.UIKit.IUIEntity);
            args = new Type[]{};
            method = type.GetMethod("get_UIPage", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_UIPage_0);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new TinaX.UIKit.IUIEntity[s]);


        }


        static StackObject* get_UIPage_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            TinaX.UIKit.IUIEntity instance_of_this_method = (TinaX.UIKit.IUIEntity)typeof(TinaX.UIKit.IUIEntity).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            var result_of_this_method = instance_of_this_method.UIPage;
        ...
        static StackObject* Close_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Close(@args);
